...
<meta name="theme-color" content="#0a3d48" />
...
<link href="https://fonts.googleapis.com/css2?family=Figtree:wght@400;600;700;800&family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700&display=swap" rel="stylesheet" />
    ...
    <header class="header">
      <div class="topheader">
        <div class="topheader-left">
          <a href="/" title="Free online chat rooms">${SITE_NAME}</a>
          <p class="description">Free rooms. Instant talk. No signup.</p>
        </div>
...
<link rel="stylesheet" href="/css/style.css" />
<style>body{background:#f7f2ea;margin:0} .wrapper,.mainbody{width:auto;min-height:0;box-shadow:none}</style>
</head>
<body>

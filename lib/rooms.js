...
const nav = [
  ...
  { href: "/telugu-chat-rooms/", label: "Telugu" },
  { href: "/usa-chat-rooms/", label: "USA" },
  { href: "/chennai-chat-rooms/", label: "Chennai" },
  { href: "/global-chat-rooms/", label: "Global" },
  { href: "/philippines-chat-rooms/", label: "Philippines" },
  {
    href: "/chat-rooms/",
    label: "Chat Rooms",
    children: [
      { href: "/chat-rooms/asia-chat-rooms/", label: "Asia" },
      { href: "/chat-rooms/ethiopia-chat-rooms/", label: "Ethiopia" },
      { href: "/chat-rooms/friendship-chat-rooms/", label: "Friendship" },
      { href: "/chat-rooms/feedback/", label: "Feedback" }
    ]
  },
  { href: "/help/", label: "Terms" },
  {
    ...
    label: "Pages",
    children: [
      { href: "/pages/disclaimers/", label: "Disclaimers" },
      { href: "/pages/privacypolicy/", label: "Privacy" },
      { href: "/pages/safetytips/", label: "Safety" }
    ]
  }
];
